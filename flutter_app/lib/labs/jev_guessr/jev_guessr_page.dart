...
class _JevGuessrPageState extends State<JevGuessrPage> {
  ...
  Widget build(BuildContext context) {
                    ...
                    children: [
                      ...
                      Wrap(spacing: 12, children: [
                        for (final c in GuessCategory.values)
                          ChoiceChip(
                            label:
                                Text(c.name == 'fruit' ? 'Fruits' : 'Animals'),
                      ...
                      TextField(
                          controller: input,
                          enabled: !busy && game.status != GameStatus.success,
                          minLines: 3,
                          maxLines: 5,
                      ...
                      Wrap(spacing: 12, runSpacing: 12, children: [
                        FilledButton(
                            ...
                            onPressed: busy || game.status == GameStatus.success
                                ? null
                      ...
                      if (d != null) ...[
                        ...
                        Text(
                            widget.mock ? 'SYNTHETIC DECISION' : 'JEV DECISION',
                            style: Theme.of(context).textTheme.titleLarge),
                        const SizedBox(height: 12),
                        for (final entry in d.identity.probabilities.entries)
                      ...
                      ExpansionTile(
                          ...
                          children: [
                            ...
                            if (d != null) ...[
                              ...
                              Text('Score: ambiguity = ${d.ambiguity.score}'),
    ...
    return widget.embedded
        ? content
        : Scaffold(
            appBar: AppBar(title: const Text('Jev Guessr')), body: content);
  }
